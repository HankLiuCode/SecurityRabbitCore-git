...
# signers
def analysis_summary(filepath, sigcheck_exe_path, userdb_filter_txt):
    analysis_dict = {}
    analysis_dict.update(file_info(filepath))
    analysis_dict.update(sigcheck(filepath, sigcheck_exe_path))
    analysis_dict.update(analysis_pefile(filepath, userdb_filter_txt))
